...
class GameCell extends StatefulWidget {
  ...
  final int? value;
  const GameCell({Key? key, required this.isDragging, required this.cardSize, this.value}) : super(key: key);
      ...
      child: Container(
        ...
        BoxDecoration(
          image: DecorationImage(
            image: AssetImage(gemsPath +  GameTableHelper.getGemImage(widget.value)),
            fit: BoxFit.contain,
          ),
